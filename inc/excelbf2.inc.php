...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Worksheet ss:Name="Hoja1">
	<?php  
	if(count($renglon_bit)<=11){
		$factor=11-count($renglon_bit);
		$exp=62;
	} elseif(($renglon_bit)>11){
		$factor=count($renglon_bit)-11;
		$exp=62+($factor*4);
	}
	
	?>
  <Names>
   <NamedRange ss:Name="Print_Area" ss:RefersTo="=Hoja1!R1C1:R<?php echo $exp;?>C14"/>
  </Names>
  ...
  <Table ss:ExpandedColumnCount="14" ss:ExpandedRowCount="<?php echo $exp;?>" x:FullColumns="1"
   ...
   <Row ss:AutoFitHeight="0" ss:Height="32.25">
    <Cell ss:MergeAcross="8" ss:StyleID="m133903516"><Data ss:Type="String"><?php echo $renglon_bit[0]['division']?></Data><NamedCell
      ss:Name="Print_Area"/></Cell>
    <Cell ss:MergeAcross="4" ss:StyleID="m133903536"><Data ss:Type="String"><?php echo $renglon_bit[0]['laboratorio']?></Data><NamedCell
      ss:Name="Print_Area"/></Cell>
   </Row>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="42">
    ...
    <Cell ss:StyleID="s108"><Data ss:Type="String">Semestre:</Data><NamedCell
      ss:Name="Print_Area"/></Cell>
    <Cell ss:StyleID="s109"><Data ss:Type="String"><?php echo $renglon_bit[0]['semestre']?></Data><NamedCell
      ss:Name="Print_Area"/></Cell>
    <Cell ss:StyleID="s104"><NamedCell ss:Name="Print_Area"/></Cell>
    <Cell ss:StyleID="s104"><NamedCell ss:Name="Print_Area"/></Cell>
    <Cell ss:StyleID="s104"><NamedCell ss:Name="Print_Area"/></Cell>
...
?>
   ...
   <Row ss:AutoFitHeight="0" ss:Height="26.25">
    <Cell ss:MergeAcross="13" ss:StyleID="s226"><Data ss:Type="String"><?php echo $renglon_bit[0]['rl_nombre'] ." ". $renglon_bit[0]['rl_apaterno'] ." ". $renglon_bit[0]['rl_amaterno'];?></Data><NamedCell
      ss:Name="Print_Area"/></Cell>
   </Row>
   <Row ss:AutoFitHeight="0" ss:Height="26.25">
