...
$queryarea="SELECT nombre FROM laboratorios
           WHERE id_lab=" .  $_REQUEST['lab'];
		   
$registroarea = pg_query($con,$queryarea);
$nombarea= pg_fetch_array($registroarea);
...
$texto='Content-Disposition: attachment;filename="inventariogenarea_' . date("Ymd-His") . "_" . $nombarea[0] . '.xls"';
header($texto);
...
<table>
   <tr>
      <td align="center" ><h2>Inventario General por Área</h2></td>
