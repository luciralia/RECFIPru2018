...
?>
   ...
   <tr>
   <td align="center"><h2>Bibliotecas</h2></td>
   </tr>
   ...
   <td align="center"><h3>Anteriores a Pentium 4 o equivalentes</h3></td>
    ...
    <td ></td>
		...
		<?php 
    $query=$censoxls->CensoUFBNoMac($_SESSION['tipo_usuario'],$_SESSION['id_div'],$_REQUEST['lab']);
...
$query=$censoxls->CensoUFBMac($_SESSION['tipo_usuario'],$_SESSION['id_div'],$_REQUEST['lab']);
