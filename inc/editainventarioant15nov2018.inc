...
<table  class="formulario">
   <tr align="right"><h3>Equipo de cómputo -Por dispositivo</h3></tr>
   <tr>
      <td align="right" >Dispositivo</td>
      <td  ><?php $combo->combodispositivo($_POST['dispositivo_clave'])?></td>
     ...
     <td><input type="text" name="descextensa" id="descextensa"size="55" value="<?php  echo $_POST['descextensa'];?>" required></td>
      </tr>
 ...
 <table cellpadding="5" class="formulario">
  <tr ><h3>Resguardo</h3></tr>
   <tr>
   <td   align="right" >Nombre</td>
     <td align="right"><input type="text" name="nombre_resguardo"  id="nombre_resguardo" size="37"  value="<?php echo $_POST['nombre_resguardo'];?>" required></td>
    <td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td>
    <td></td><td></td><td></td><td></td><td></td><td></td><td></td>
    
  <td  align="right"  >Número de empleado</td>
     <td align="right" ><input type="text" name="resguardo_no_empleado" id="resguardo_no_empleado"size="10" value="<?php echo $_POST['resguardo_no_empleado'];?>" required ></td>
    </tr>
      <td  align="right"  >Modo de Adquisición</td>
 ...
 <table cellpadding="5" class="formulario">
  ...
  <td  align="right" >Ubicación</td>
     <td><input type="text" name="usuario_ubicacion" id="usuario_ubicacion"size="18" value="<?php echo $_POST['usuario_ubicacion'];?>" required ></td>
    </tr>
    <tr>
 ...
 <table cellpadding="5" class="formulario">
  <tr align="center" ><h3>Información de patronato</h3></tr>
  <tr>
  ...
  <tr>
   ...
   <table cellpadding="5" class="formulario">
  <tr  ><h3>Información del procesador</h3></tr>
  <tr>
 ...
 <table cellpadding="5" class="formulario">
  <tr ><h3>Núcleos GPU</h3></tr>
   ...
   <table cellpadding="5" class="formulario">
   <tr align="center" ><h3>Memoria RAM</h3></tr>
  ...
  <table cellpadding="5" class="formulario">
  <tr align="center" ><h3>Almacenamiento</h3></tr>
  
  <td ><h5>Almacenamiento estándar</h5></td>
 ...
 <tr><h3>Plataforma</h3></tr>
   ...
   <?php } ?>
    ...
    <!-- <td >  <input type="checkbox" name="licencia" id="licencia" onChange="palomeado(this);" value="<?php //echo $lic;?>"  /></td>-->
     <td align="right" ><input type="checkbox" name="licencia" id="licencia"  <?php echo $checked ?> onChange="palomeado(this);" value="<?php echo $_POST['licencia'];?>"  /> <label for="licencia"></label></td>
     
     <td >  <label for="licencia">Permanente</label></td>
     
      <?php if ( $_POST['licencia']==1 ) { ?>
     <td align="right"  >  <label for="licencia_ini">Inicia</label></td>
