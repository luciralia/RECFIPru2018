...
?>
   ...
   <tr>
      <td align="center"><h2>Censo Equipo Digital</h2></td>
   </tr>
   
    
		<?php 

$query=$censoxls->CensoEquDigital($_SESSION['tipo_usuario'],$_SESSION['id_div'],$_REQUEST['lab']);
		...
		{ ?>
		 ...
		 <table class='material'>
           <tr>
               ...
               <td width="30%" scope="col"><?php echo $lab_invent['bien'];?></td>
