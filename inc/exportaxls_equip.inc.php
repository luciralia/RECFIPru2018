...
<table border="1">
  <tr>
    <th scope="col">Recursos de cómputo</th>
...
if ($_REQUEST['lab']!='') {
	$tab='dispositivo';			
	$renglon_xls=$obj_xls->tblXls($_REQUEST['lab'],$_REQUEST['mod'],$tab,$_SESSION['tipo_usuario']);
...
?>
  <tr>
    <td><?php echo $renglon_xls[$i]['nomb_recurso']; ?></td>
	...
	<td><?php echo $renglon_xls[$i]['id_prio']; ?></td>
	<td><?php echo $renglon_xls[$i]['plazo']; ?></td>
    <td><?php echo substr($renglon_xls[$i]['ruta_evidencia'],strpos($renglon_xls[$i]['ruta_evidencia'],'_')+3); ?></td>
