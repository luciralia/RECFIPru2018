...
$strquery="INSERT INTO nec_mobiliario (id_lab, cant, especificaciones, justificacion, tipo) VALUES (%d,%d,'%s','%s','%s')";
$queryn=sprintf($strquery,$_REQUEST['lab'],$_POST['cant'],$_POST['especificaciones'],$_POST['justificacion'],$_POST['tipo']);
...
/* *******************  La buena  *********** */
$strquery="UPDATE nec_mobiliario SET id_lab=%d, cant=%d, especificaciones='%s', justificacion='%s', tipo='%s' where id_nec=" . $_POST['id_nec'];
$queryu=sprintf($strquery,$_REQUEST['lab'],$_POST['cant'],$_POST['especificaciones'],$_POST['justificacion'],$_POST['tipo']);
