...
echo "Nuevo registro de material </br>";
print_r($_REQUEST);
...
<table cellpadding="2" class="formulario">
  <tr>
    ...
    <td colspan="2" ><div class="recuadro">
      <p>
        <label>
          <input name="tipo_mant" type="radio" id="tipo_mant_0" value="P" checked="checked" />
          Preventivo</label>
        &nbsp;&nbsp;&nbsp;&nbsp;
        <label>
          <input type="radio" name="tipo_mant" value="C" id="tipo_mant_1" />
          Correctivo</label>
        <br />
      </p>
    </div></td>
  ...
  <tr>
    ...
    <td colspan="2"><?php $combocot->cmbCotiza($_REQUEST['lab'],'eq',$_REQUEST['id_cotizacion']); ?></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="3"><div class="recuadro"><p>¿El servicio de mantenimiento debe ser realizado en sitio? </p>
      <p>
        <label>
