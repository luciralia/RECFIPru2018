...
<div style="text-align: right"> <div id="botonblu" > <a href="<?php echo $action1 . '../inc/&accion=nuevo';?>">Nuevo</a></div></div>	
...
<form action="../inc/inicio.html.php" method="get" name="orderby">
