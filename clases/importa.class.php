...
function revisarError($revisar,$tupla){
	...
	<?php  } ?>
      ...
      <?php if ($disperror['columna46']==0) {?>
		     <!-- <tr><td>--> <legend align="left"> <?php echo 'La columna AT, <strong> version_sist_oper </strong> del renglón correpondiente al no.inventario  '.$disperror['inventario'].' es obligatoria.'; ?></legend><!--</td></tr>-->
      <?php } ?>
      <?php if ($disperror['columna47']==0)  {?>
		      <!-- <tr><td>--> <legend align="left"><?php echo 'La columna AU, <strong> licencia </strong> del renglón correpondiente al no.inventario  '.$disperror['inventario'].' es obligatoria.'; ?></legend><!--</td></tr>-->      
	  <?php } ?>
      
       <?php if ($disperror['columna47']==2)  {?>
		     <!-- <tr><td>--> <legend align="left"> <?php echo 'La columna AU, <strong> licencia </strong> del renglón correpondiente al no.inventario  '.$disperror['inventario'].' debe ser numérica.'; ?></legend><!--</td></tr>--><?php } ?>
      ...
      <?php if ($disperror['columna48']==3) { ?>
		      <!-- <tr><td>--> <legend align="left"> <?php echo 'El formato de fecha de la columna AV, <strong> licencia_ini </strong> del renglón correpondiente al no.inventario  '.$disperror['inventario'].' es incorrecto.'; ?></legend><!--</td></tr>-->
      <?php } ?>
